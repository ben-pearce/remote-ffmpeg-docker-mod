...
FROM alpine:3.24.0@sha256:a2d49ea686c2adfe3c992e47dc3b5e7fa6e6b5055609400dc2acaeb241c829f4 AS sshfs
ARG SSHFS_VERSION
ARG LIBFUSE_VERSION
ARG LIBFUSE_URL
ARG SSHFS_URL
...
FROM alpine:3.24.0@sha256:a2d49ea686c2adfe3c992e47dc3b5e7fa6e6b5055609400dc2acaeb241c829f4 AS bwrap
ARG BUBBLEWRAP_URL
...
FROM lscr.io/linuxserver/baseimage-alpine:3.23-9586c06d-ls16@sha256:849505f405c7d2d21a2e587708a6cf3ec4fb86acbbb543348f0f07d3c9aeb0fc AS buildstage
ARG SSHFS_VERSION
ARG LIBFUSE_VERSION
ARG BUBBLEWRAP_VERSION
