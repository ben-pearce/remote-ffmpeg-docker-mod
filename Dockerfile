...
FROM alpine:3.23.4@sha256:5b10f432ef3da1b8d4c7eb6c487f2f5a8f096bc91145e68878dd4a5019afde11 AS sshfs
ARG SSHFS_VERSION
ARG LIBFUSE_VERSION
ARG LIBFUSE_URL
ARG SSHFS_URL
...
FROM alpine:3.23.4@sha256:5b10f432ef3da1b8d4c7eb6c487f2f5a8f096bc91145e68878dd4a5019afde11 AS bwrap
ARG BUBBLEWRAP_URL
...
FROM lscr.io/linuxserver/baseimage-alpine:3.23-5f152c1d-ls10@sha256:5c62f8965305e6a876b31a55d4ac43609b687bcbd06c6df169ab4549c0c78c46 AS buildstage
ARG SSHFS_VERSION
ARG LIBFUSE_VERSION
ARG BUBBLEWRAP_VERSION
