...
FROM ghcr.io/linuxserver/baseimage-alpine:3.22@sha256:f619425301ad5c227c980bd38e8af3ee55c1d0aafc7efff570fa799196eb653a AS buildstage
ARG SSHFS_VERSION
ARG LIBFUSE_VERSION
ARG BUBBLEWRAP_VERSION
